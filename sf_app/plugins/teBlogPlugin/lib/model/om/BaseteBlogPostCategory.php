...
/**
 * Base class that represents a row from the 'te_blog_post_category' table.
 *
 * 
 *
 * @package    propel.generator.plugins.teBlogPlugin.lib.model.om
 */
abstract class BaseteBlogPostCategory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'teBlogPostCategoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        teBlogPostCategoryPeer
	 */
	 ...
	 * @return     teBlogPostCategory The current object (for fluent API support)
	 */
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = teBlogPostCategoryPeer::NAME;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = teBlogPostCategoryPeer::ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = teBlogPostCategoryPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = teBlogPostCategoryPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = teBlogPostCategoryPeer::SLUG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = teBlogPostCategoryPeer::NUM_COLUMNS - teBlogPostCategoryPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating teBlogPostCategory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = teBlogPostCategoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseteBlogPostCategory:delete:pre') as $callable)
			{
			...
			if ($ret) {
				teBlogPostCategoryQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseteBlogPostCategory:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($this->isColumnModified(teBlogPostCategoryPeer::SLUG) && $this->getSlug()) {
				$this->setSlug($this->makeSlugUnique($this->getSlug()));
			} elseif (!$this->getSlug()) {
				$this->setSlug($this->createSlug());
			}
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseteBlogPostCategory:save:pre') as $callable)
			{
			...
			if ($isInsert) {
				...
				if (!$this->isColumnModified(teBlogPostCategoryPeer::CREATED_AT)) {
					$this->setCreatedAt(time());
				}
				if (!$this->isColumnModified(teBlogPostCategoryPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			} else {
				$ret = $ret && $this->preUpdate($con);
				// timestampable behavior
				if ($this->isModified() && !$this->isColumnModified(teBlogPostCategoryPeer::UPDATED_AT)) {
					$this->setUpdatedAt(time());
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseteBlogPostCategory:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				teBlogPostCategoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(teBlogPostCategoryPeer::ID) ) {
					...
					$affectedRows = teBlogPostCategoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = teBlogPostCategoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = teBlogPostCategoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = teBlogPostCategoryPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getName(),
			$keys[1] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(teBlogPostCategoryPeer::NAME)) $criteria->add(teBlogPostCategoryPeer::NAME, $this->name);
		if ($this->isColumnModified(teBlogPostCategoryPeer::ID)) $criteria->add(teBlogPostCategoryPeer::ID, $this->id);
		if ($this->isColumnModified(teBlogPostCategoryPeer::CREATED_AT)) $criteria->add(teBlogPostCategoryPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(teBlogPostCategoryPeer::UPDATED_AT)) $criteria->add(teBlogPostCategoryPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(teBlogPostCategoryPeer::SLUG)) $criteria->add(teBlogPostCategoryPeer::SLUG, $this->slug);
	...
	{
		$criteria = new Criteria(teBlogPostCategoryPeer::DATABASE_NAME);
		$criteria->add(teBlogPostCategoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of teBlogPostCategory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     teBlogPostCategory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     teBlogPostCategoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new teBlogPostCategoryPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this teBlogPostCategory is new, it will return
	 ...
	 * Otherwise if this teBlogPostCategory is new, it will return
	 * an empty collection; or if this teBlogPostCategory has previously
	 * been saved, it will retrieve related teBlogPostToCategoryLinks from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in teBlogPostCategory.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array teBlogPostToCategoryLink[] List of teBlogPostToCategoryLink objects
	 */
	public function getteBlogPostToCategoryLinksJoinPost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = teBlogPostToCategoryLinkQuery::create(null, $criteria);
	...
	public function initPosts()
	{
		...
		$this->collPosts->setModel('teBlogPost');
	}

	/**
	 * Gets a collection of teBlogPost objects related by a many-to-many relationship
	...
	public function getPosts($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collPosts || null !== $criteria) {
			if ($this->isNew() && null === $this->collPosts) {
				...
				$collPosts = teBlogPostQuery::create(null, $criteria)
					->filterByCategory($this)
					->find($con);
				if (null !== $criteria) {
					return $collPosts;
	...
	/**
	 * Gets the number of teBlogPost objects related by a many-to-many relationship
	 * to the current object by way of the te_blog_posts_to_categories cross-reference table.
	 *
	 * @param      Criteria $criteria Optional query object to filter the query
	 ...
	 * @param      PropelPDO $con Optional connection object
	 *
	 * @return     int the number of related teBlogPost objects
	 */
	...
	/**
	 * Associate a teBlogPost object to this object
	 * through the te_blog_posts_to_categories cross reference table.
	 *
	 * @param      teBlogPost $teBlogPost The teBlogPostToCategoryLink object to relate
	 * @return     void
	 */
	public function addPost($teBlogPost)
	{
		if ($this->collPosts === null) {
			$this->initPosts();
		}
		if (!$this->collPosts->contains($teBlogPost)) { // only add it if the **same** object is not already associated
			$teBlogPostToCategoryLink = new teBlogPostToCategoryLink();
			$teBlogPostToCategoryLink->setPost($teBlogPost);
			$this->addteBlogPostToCategoryLink($teBlogPostToCategoryLink);

			$this->collPosts[]= $teBlogPost;
		}
	}
	...
	protected function makeSlugUnique($slug, $separator = '-', $increment = 0)
	{
		...
		$slugAlreadyExists = teBlogPostCategoryQuery::create()
			->filterBySlug($slug2)
			->prune($this)
			->count();
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseteBlogPostCategory:' . $name))
		{
