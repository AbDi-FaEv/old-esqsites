 ...
 * @version SVN: $Id: sfPropelObject.class.php 21747 2009-09-07 16:22:28Z Dannyrulez $
 */
class sfPropelObject
{
  ...
  public function hydrate($stmt, $startcol = 1)
  {
    try
    {
      foreach($this->columns as $_array)
      {
        ...
        $this->$name = $stmt->fetchColumn($startcol);
        $startcol++;
      }
