...
abstract class BasesfGuardPermissionPeer {
	...
	const TITLE = 'sf_guard_permission.TITLE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Description', 'Title', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'description', 'title', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::DESCRIPTION, self::TITLE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'DESCRIPTION', 'TITLE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'description', 'title', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Description' => 2, 'Title' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'title' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::DESCRIPTION => 2, self::TITLE => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, 'TITLE' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'description' => 2, 'title' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(sfGuardPermissionPeer::TITLE);
		} else {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = sfGuardPermissionPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + sfGuardPermissionPeer::NUM_COLUMNS;
		} else {
	...
	{
	  return array(array('name'), array('title'));
	}
