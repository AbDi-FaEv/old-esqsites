 ...
 * @method     sfGuardPermissionQuery orderByTitle($order = Criteria::ASC) Order by the title column
 *
 ...
 * @method     sfGuardPermissionQuery groupByTitle() Group by the title column
 *
 ...
 * @method     sfGuardPermission findOneByTitle(string $title) Return the first sfGuardPermission filtered by the title column
 *
 ...
 * @method     array findByTitle(string $title) Return sfGuardPermission objects filtered by the title column
 *
...
abstract class BasesfGuardPermissionQuery extends ModelCriteria
{
	...
	public function filterByTitle($title = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(sfGuardPermissionPeer::TITLE, $title, $comparison);
	}
