...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('Customer', 'Customer', RelationMap::ONE_TO_MANY, array('id' => 'sales_person_id', ), 'SET NULL', null);
    ...
    $this->addRelation('sfComment', 'sfComment', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), 'SET NULL', null);
    $this->addRelation('teBlogPostRelatedByAuthorId', 'teBlogPost', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), 'CASCADE', null);
    $this->addRelation('teBlogPostRelatedByCreatedBy', 'teBlogPost', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'SET NULL', null);
    $this->addRelation('teBlogPostRelatedByUpdatedBy', 'teBlogPost', RelationMap::ONE_TO_MANY, array('id' => 'updated_by', ), 'SET NULL', null);
    $this->addRelation('teCalendarEventRelatedByCreatedBy', 'teCalendarEvent', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'SET NULL', null);
    $this->addRelation('teCalendarEventRelatedByUpdatedBy', 'teCalendarEvent', RelationMap::ONE_TO_MANY, array('id' => 'updated_by', ), 'SET NULL', null);
    $this->addRelation('teTestimonialRelatedByCreatedBy', 'teTestimonial', RelationMap::ONE_TO_MANY, array('id' => 'created_by', ), 'SET NULL', null);
    $this->addRelation('teTestimonialRelatedByUpdatedBy', 'teTestimonial', RelationMap::ONE_TO_MANY, array('id' => 'updated_by', ), 'SET NULL', null);
	} // buildRelations()
