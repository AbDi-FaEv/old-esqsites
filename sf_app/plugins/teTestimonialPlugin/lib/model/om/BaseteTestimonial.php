...
/**
 * Base class that represents a row from the 'te_testimonials' table.
 *
 * 
 *
 * @package    propel.generator.plugins.teTestimonialPlugin.lib.model.om
 */
abstract class BaseteTestimonial extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'teTestimonialPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        teTestimonialPeer
	 */
	...
	/**
	 * Initializes internal state of BaseteTestimonial object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     teTestimonial The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = teTestimonialPeer::ID;
		}
	...
	public function setSource($v)
	{
		...
		if ($this->source !== $v) {
			$this->source = $v;
			$this->modifiedColumns[] = teTestimonialPeer::SOURCE;
		}
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = teTestimonialPeer::LOCATION;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = teTestimonialPeer::COMPANY;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = teTestimonialPeer::CONTENT;
		}
	...
	public function setDate($v)
	{
		...
		if ( $this->date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = teTestimonialPeer::DATE;
			}
	...
	public function setIsPublished($v)
	{
		...
		if ($this->is_published !== $v || $this->isNew()) {
			$this->is_published = $v;
			$this->modifiedColumns[] = teTestimonialPeer::IS_PUBLISHED;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = teTestimonialPeer::CREATED_AT;
			}
		} // if either are not null
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = teTestimonialPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = teTestimonialPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = teTestimonialPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = teTestimonialPeer::NUM_COLUMNS - teTestimonialPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating teTestimonial object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = teTestimonialPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseteTestimonial:delete:pre') as $callable)
			{
			...
			if ($ret) {
				teTestimonialQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseteTestimonial:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseteTestimonial:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(teTestimonialPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(teTestimonialPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseteTestimonial:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				teTestimonialPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(teTestimonialPeer::ID) ) {
					...
					$affectedRows += teTestimonialPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = teTestimonialPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = teTestimonialPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = teTestimonialPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(teTestimonialPeer::ID)) $criteria->add(teTestimonialPeer::ID, $this->id);
		if ($this->isColumnModified(teTestimonialPeer::SOURCE)) $criteria->add(teTestimonialPeer::SOURCE, $this->source);
		if ($this->isColumnModified(teTestimonialPeer::LOCATION)) $criteria->add(teTestimonialPeer::LOCATION, $this->location);
		if ($this->isColumnModified(teTestimonialPeer::COMPANY)) $criteria->add(teTestimonialPeer::COMPANY, $this->company);
		if ($this->isColumnModified(teTestimonialPeer::CONTENT)) $criteria->add(teTestimonialPeer::CONTENT, $this->content);
		if ($this->isColumnModified(teTestimonialPeer::DATE)) $criteria->add(teTestimonialPeer::DATE, $this->date);
		if ($this->isColumnModified(teTestimonialPeer::IS_PUBLISHED)) $criteria->add(teTestimonialPeer::IS_PUBLISHED, $this->is_published);
		if ($this->isColumnModified(teTestimonialPeer::CREATED_AT)) $criteria->add(teTestimonialPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(teTestimonialPeer::UPDATED_AT)) $criteria->add(teTestimonialPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(teTestimonialPeer::CREATED_BY)) $criteria->add(teTestimonialPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(teTestimonialPeer::UPDATED_BY)) $criteria->add(teTestimonialPeer::UPDATED_BY, $this->updated_by);
	...
	{
		$criteria = new Criteria(teTestimonialPeer::DATABASE_NAME);
		$criteria->add(teTestimonialPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of teTestimonial (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     teTestimonial Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     teTestimonialPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new teTestimonialPeer();
		}
		return self::$peer;
	}
	...
	public function setsfGuardUserRelatedByCreatedBy(sfGuardUser $v = null)
	{
		...
		if ($v !== null) {
			$v->addteTestimonialRelatedByCreatedBy($this);
		}
	...
	public function getsfGuardUserRelatedByCreatedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->asfGuardUserRelatedByCreatedBy->addteTestimonialsRelatedByCreatedBy($this);
			 */
		}
	...
	public function setsfGuardUserRelatedByUpdatedBy(sfGuardUser $v = null)
	{
		...
		// If this object has already been added to the sfGuardUser object, it will not be re-added.
		if ($v !== null) {
			$v->addteTestimonialRelatedByUpdatedBy($this);
		}
	...
	public function getsfGuardUserRelatedByUpdatedBy(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->asfGuardUserRelatedByUpdatedBy->addteTestimonialsRelatedByUpdatedBy($this);
			 */
		}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseteTestimonial:' . $name))
		{
