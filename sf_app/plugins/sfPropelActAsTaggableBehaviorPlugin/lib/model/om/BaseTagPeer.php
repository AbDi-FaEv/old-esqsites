...
abstract class BaseTagPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('iD', 'name', 'isTriple', 'tripleNamespace', 'tripleKey', 'tripleValue', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::IS_TRIPLE, self::TRIPLE_NAMESPACE, self::TRIPLE_KEY, self::TRIPLE_VALUE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'IS_TRIPLE', 'TRIPLE_NAMESPACE', 'TRIPLE_KEY', 'TRIPLE_VALUE', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('iD' => 0, 'name' => 1, 'isTriple' => 2, 'tripleNamespace' => 3, 'tripleKey' => 4, 'tripleValue' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::IS_TRIPLE => 2, self::TRIPLE_NAMESPACE => 3, self::TRIPLE_KEY => 4, self::TRIPLE_VALUE => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'IS_TRIPLE' => 2, 'TRIPLE_NAMESPACE' => 3, 'TRIPLE_KEY' => 4, 'TRIPLE_VALUE' => 5, ),
	...
	/**
	 * Method to invalidate the instance pool of all tables related to sf_tag
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// Invalidate objects in TaggingPeer instance pool, 
	...
	{
		$key = TagPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = TagPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(TagPeer::ID);
			if ($value) {
				$selectCriteria->add(TagPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(TagPeer::TABLE_NAME);
			}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(TaggingPeer::TAG_ID, $obj->getID());
			$affectedRows += TaggingPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
