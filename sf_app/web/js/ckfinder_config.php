...
function CheckAuthentication()
{
    ...
    return $_SESSION["symfony/user/sfUser/authenticated"];
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'Golden State Web Solutions ';
$config['LicenseKey'] = 'S6XQ-VW2F-6FVT-9AEQ-NCXC-L4GC-97UP';
...
*/
//$baseUrl = '/uploads/';
$baseUrl = $_SESSION["symfony/user/sfUser/attributes"]["symfony/user/sfUser/attributes"]["userfiles_url"]."/";
//file_put_contents("/home/mshannon/hosts/esqsites123.com/sf_app/log/fck_dir.txt", "URL: ".$baseUrl);
/*
