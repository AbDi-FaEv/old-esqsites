 ...
 */
class esqTwigExtension extends Twig_Extension
{
  ...
  {
    return array(
        "format_phone" => new Twig_Filter_Method($this, "formatPhone"),
        "break" => new Twig_Filter_Method($this, "breakByDelimiter"));
  }

  public function breakByDelimiter($value)
  {
   ...
   * -------------------------------------------------------------
   */
  public function formatPhone($sPhone, $sCountry = 'US', $bInternationalFormat = false)
  {
    if (empty($sPhone)
	|| !trim($sPhone)) {
		return $sPhone;
