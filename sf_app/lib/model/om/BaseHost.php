...
/**
 * Base class that represents a row from the 'esq_hosts' table.
 *
 * 
 *
...
abstract class BaseHost extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the global_document_root field.
	 * @var        string
	 */
	protected $global_document_root;

	/**
	 * The value for the save_max field.
	 * @var        int
	 */
	protected $save_max;
	...
	/**
	 * Get the [global_document_root] column value.
	 * 
	 * @return     string
	 */
	public function getGlobalDocumentRoot()
	{
		return $this->global_document_root;
	}

	/**
	 * Get the [save_max] column value.
	 * 
	 * @return     int
	 */
	public function getSaveMax()
	{
		return $this->save_max;
	}
	...
	public function setInternalIp($v)
	{
		...
		if ($this->internal_ip !== $v) {
			$this->internal_ip = $v;
			$this->modifiedColumns[] = HostPeer::INTERNAL_IP;
		}
	...
	public function setExternalIp($v)
	{
		...
		if ($this->external_ip !== $v) {
			$this->external_ip = $v;
			$this->modifiedColumns[] = HostPeer::EXTERNAL_IP;
		}
	...
	public function setPort($v)
	{
		...
		if ($this->port !== $v) {
			$this->port = $v;
			$this->modifiedColumns[] = HostPeer::PORT;
		}
	...
	/**
	 * Set the value of [global_document_root] column.
	 * 
	 * @param      string $v new value
	 * @return     Host The current object (for fluent API support)
	 */
	public function setGlobalDocumentRoot($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->global_document_root !== $v) {
			$this->global_document_root = $v;
			$this->modifiedColumns[] = HostPeer::GLOBAL_DOCUMENT_ROOT;
		}

		return $this;
	} // setGlobalDocumentRoot()

	/**
	 * Set the value of [save_max] column.
	 * 
	 * @param      int $v new value
	 * @return     Host The current object (for fluent API support)
	 */
	public function setSaveMax($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->save_max !== $v) {
			$this->save_max = $v;
			$this->modifiedColumns[] = HostPeer::SAVE_MAX;
		}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = HostPeer::TYPE;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = HostPeer::STATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->internal_ip = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->external_ip = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->port = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->name = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->global_document_root = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->save_max = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			...
			return $startcol + 11; // 11 = HostPeer::NUM_COLUMNS - HostPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseHost:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseHost:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseHost:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseHost:save:post') as $callable)
				{
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				return $this->getGlobalDocumentRoot();
				break;
			case 6:
				return $this->getSaveMax();
				break;
			case 7:
				return $this->getType();
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getInternalIp(),
			$keys[2] => $this->getExternalIp(),
			$keys[3] => $this->getPort(),
			$keys[4] => $this->getName(),
			$keys[5] => $this->getGlobalDocumentRoot(),
			$keys[6] => $this->getSaveMax(),
			$keys[7] => $this->getType(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				$this->setGlobalDocumentRoot($value);
				break;
			case 6:
				$this->setSaveMax($value);
				break;
			case 7:
				$this->setType($value);
				break;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setInternalIp($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setExternalIp($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setPort($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setName($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setGlobalDocumentRoot($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setSaveMax($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(HostPeer::INTERNAL_IP)) $criteria->add(HostPeer::INTERNAL_IP, $this->internal_ip);
		if ($this->isColumnModified(HostPeer::EXTERNAL_IP)) $criteria->add(HostPeer::EXTERNAL_IP, $this->external_ip);
		if ($this->isColumnModified(HostPeer::PORT)) $criteria->add(HostPeer::PORT, $this->port);
		if ($this->isColumnModified(HostPeer::NAME)) $criteria->add(HostPeer::NAME, $this->name);
		if ($this->isColumnModified(HostPeer::GLOBAL_DOCUMENT_ROOT)) $criteria->add(HostPeer::GLOBAL_DOCUMENT_ROOT, $this->global_document_root);
		if ($this->isColumnModified(HostPeer::SAVE_MAX)) $criteria->add(HostPeer::SAVE_MAX, $this->save_max);
		if ($this->isColumnModified(HostPeer::TYPE)) $criteria->add(HostPeer::TYPE, $this->type);
		if ($this->isColumnModified(HostPeer::STATUS)) $criteria->add(HostPeer::STATUS, $this->status);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setInternalIp($this->internal_ip);
		$copyObj->setExternalIp($this->external_ip);
		$copyObj->setPort($this->port);
		$copyObj->setName($this->name);
		$copyObj->setGlobalDocumentRoot($this->global_document_root);
		$copyObj->setSaveMax($this->save_max);
	...
	public function clear()
	{
		...
		$this->port = null;
		$this->name = null;
		$this->global_document_root = null;
		$this->save_max = null;
		$this->type = null;
		$this->status = null;
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseHost:' . $name))
		{
