...
/**
 * Base class that represents a row from the 'esq_resources' table.
 *
 * 
 *
...
abstract class BaseResource extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the url_title field.
	 * @var        string
	 */
	protected $url_title;
	...
	/**
	 * Get the [url_title] column value.
	 * 
	 * @return     string
	 */
	...
	public function setCompanyName($v)
	{
		...
		if ($this->company_name !== $v) {
			$this->company_name = $v;
			$this->modifiedColumns[] = ResourcePeer::COMPANY_NAME;
		}
	...
	public function setImageUrl($v)
	{
		...
		if ($this->image_url !== $v) {
			$this->image_url = $v;
			$this->modifiedColumns[] = ResourcePeer::IMAGE_URL;
		}
	...
	/**
	 * Set the value of [url_title] column.
	 * 
	 * @param      string $v new value
	 * @return     Resource The current object (for fluent API support)
	 */
	public function setUrlTitle($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->url_title !== $v) {
			$this->url_title = $v;
			$this->modifiedColumns[] = ResourcePeer::URL_TITLE;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = ResourcePeer::EMAIL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->company_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->image_url = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->url = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->url_title = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			...
			return $startcol + 9; // 9 = ResourcePeer::NUM_COLUMNS - ResourcePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aResourceCategory) {
				$result['ResourceCategory'] = $this->aResourceCategory->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setUrlTitle($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ResourcePeer::COMPANY_NAME)) $criteria->add(ResourcePeer::COMPANY_NAME, $this->company_name);
		if ($this->isColumnModified(ResourcePeer::IMAGE_URL)) $criteria->add(ResourcePeer::IMAGE_URL, $this->image_url);
		if ($this->isColumnModified(ResourcePeer::URL)) $criteria->add(ResourcePeer::URL, $this->url);
		if ($this->isColumnModified(ResourcePeer::URL_TITLE)) $criteria->add(ResourcePeer::URL_TITLE, $this->url_title);
		if ($this->isColumnModified(ResourcePeer::EMAIL)) $criteria->add(ResourcePeer::EMAIL, $this->email);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setUrlTitle($this->url_title);
	...
	{
		if ($this->aResourceCategory === null && (($this->category_id !== "" && $this->category_id !== null))) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aResourceCategory->addResources($this);
			 */
		}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseResource:' . $name))
		{
