...
/**
 * Base class that represents a row from the 'esq_resource_categories' table.
 *
 * 
 *
...
abstract class BaseResourceCategory extends BaseObject  implements Persistent
{
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = ResourceCategoryPeer::URL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ResourceCategoryPeer::NUM_COLUMNS - ResourceCategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ResourceCategoryPeer::URL)) $criteria->add(ResourceCategoryPeer::URL, $this->url);
	 ...
	 * @return     PropelCollection|array Resource[] List of Resource objects
	 * @throws     PropelException
	 */
	...
	public function addResource(Resource $l)
	{
		...
		if (!$this->collResources->contains($l)) { // only add it if the **same** object is not already associated
